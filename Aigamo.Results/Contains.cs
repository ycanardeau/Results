...
public static partial class ResultExtensions
{
	...
	[GenerateAsyncOverloads]
	public static bool Contains<T, TError>(this Result<T, TError> source, T value, IEqualityComparer<T>? comparer)
		=> source.Fold(
			onOk: resultValue => (comparer ?? EqualityComparer<T>.Default).Equals(resultValue, value),
			onError: _ => false);
}
